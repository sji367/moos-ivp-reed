...
// GPSInstrument.h: interface for the iOS5000 class.
//
//////////////////////////////////////////////////////////////////////
...
class iOS5000 : public CMOOSInstrument
{
	...
	protected:
		...
		bool ParseCRPTDString(string & sNMEAString);
